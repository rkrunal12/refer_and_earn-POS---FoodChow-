...
class RestraurentReferalMobile extends StatefulWidget {
  ...
  @override
  State<RestraurentReferalMobile> createState() => _RestraurentReferalMobileState();
}
        ...
        child: Column(
          children: [
            ...
            MobileHeader(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const AddReferralScreenMobile()));
              },
              ...
              child: Card(
                ...
                child: Consumer<ReferralProvider>(
                  builder: (context, provider, _) {
                    ...
                    return CustomTableRestaurantMobileReferral(list: provider.referralList);
                  },
                ),
              ),
            ),
